export const APPWRITE_CONFIG = {
  ...
  stylesCollectionId: import.meta.env.VITE_APPWRITE_STYLES_COLLECTION_ID as string,
  ...
  featuresBucketId: import.meta.env.VITE_APPWRITE_FEATURES_BUCKET_ID as string,
};
